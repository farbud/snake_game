...
class Food:
    ...
    def __init__(self):
        x = random.randint(0, (GAME_WIDT/SPACE_SIZE)-1) * SPACE_SIZE
...
def game_over():
    ...
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,
                       font=('consolas', 70), text="GAME OVER", fill="yellow", tags="game over")
...
canvas = Canvas(window, bg=BACKGROUND_CLOLOR,
                height=GAME_HIGHT, width=GAME_WIDT)
canvas.pack()
...
x = int((screen_width/20) - (window_widht/200))
y = int((screen_height/20) - (window_height/200))
